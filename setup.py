...
setup(
    ...
    url='https://github.com/collective/cusy.exportimport',
    project_urls={
        'PyPI': 'https://pypi.python.org/pypi/cusy.exportimport',
        'Source': 'https://github.com/collective/cusy.exportimport',
        'Tracker': 'https://github.com/collective/cusy.exportimport/issues',
    ...
    target = plone
    [console_scripts]
    update_locale = cusy.exportimport.locales.update:update_locale
    """,
)
